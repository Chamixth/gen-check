...
// @Router      /FindallCustomer [GET]
    ...
    func FindallCustomerApi(ctx context.Context, event events.APIGatewayProxyRequest) (events.APIGatewayProxyResponse,error) {


inputObj, err := dao.DB_FindallCustomer()
    if err != nil {
